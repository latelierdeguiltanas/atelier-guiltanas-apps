# MANUAL_01 — Standard débutant

## Objectif

Créer un héros simple et vérifier que chaque étape reste lisible.

## Clics et construction exacte

1. Choisis le mode Standard.
2. Saisis un nom et choisis le peuple HUMAIN.
3. Choisis le profil Voleur.
...
- Capacités réellement acquises : Discrétion R1 ; Baratin R1 ; Diversité R1.
- Budget total : 0.
- Points dépensés : 0.
- Points restants : 0.
- PV 9; DEF 13; INIT 11; PC 3; PM 0.
- Attaques : Rapière +3 / 1d6+2 ; Dague +3 / 1d4+2 ; Dague +2 / 1d4 ; Dague +3 / 1d4+2 ; Dague +2 / 1d4 ; Dague +3 / 1d4+2 ; Dague +2 / 1d4 ; Dague +3 / 1d4+2 ; Dague +2 / 1d4 ; Dague +3 / 1d4+2 ; Dague +2 / 1d4.
- Choix persistants : {"ability":{},"creation":{}}.

## Ce qui doit être bloqué

- Continuer avant le nom.
- Résumé sans équipement.
