(function () {
  ...
  const preparedTemplates = {
    ...
    'captain-log': { kind: 'text', title: 'Dernière page du journal de la capitaine', content: 'PAGE DU JOURNAL — À LIRE À VOIX HAUTE\n\n« La Rose des Vents s’est éventrée sur les récifs. L’eau gagne la cale et mes hommes tombent les uns après les autres. Ils disent que je ne verrai pas l’aube.\n\nJe refuse de mourir ici, si loin de Brastos. Je lui ai promis de revenir.\n\nJ’ai tressé nos cheveux autour de deux petits os, comme l’indique le rite. Le nom inscrit dans le vieux texte est Orcus. S’il existe une puissance capable de me ramener auprès de mon époux, je paierai son prix.\n\nJe dois maintenant achever la supplique avant que mes forces ne… »\n\nLa dernière phrase s’interrompt brutalement. Une longue traînée sombre traverse le bas de la page.' },
